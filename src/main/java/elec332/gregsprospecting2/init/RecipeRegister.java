...
public class RecipeRegister {
    ...
    public void init(FMLInitializationEvent event){
        GameRegistry.addRecipe(new ItemStack(ItemRegister.miningRadar, 1) , new ItemStack(ItemRegister.miningRadar, 1, -1), ItemRegister.battery);
        GameRegistry.addRecipe(new ItemStack(mandrel), "W", "W", "W", 'W', Blocks.planks);
        GameRegistry.addRecipe(new ItemStack(batteryCasing, 6), Items.iron_ingot, mandrel);
        GameRegistry.addRecipe(new ItemStack(carbonRod, 6), "C", "C", "C", 'C', Items.coal);
        GameRegistry.addRecipe(new ItemStack(bowlAppleJuice), Items.apple, Items.bowl);
        GameRegistry.addRecipe(new ItemStack(electrolytePaste, 6), bowlAppleJuice, new ItemStack(Items.dye, 1, 15));
        GameRegistry.addRecipe(new ItemStack(battery, 1), batteryCasing, electrolytePaste, carbonRod);
        GameRegistry.addSmelting(Items.string, new ItemStack(carbonFilament, 1), 0.0f);
        GameRegistry.addRecipe(new ItemStack(cathodeRayTube), 1, "|gG", "|gf", "|gG",
        ...
        GameRegistry.addRecipe(new ItemStack(fibreglassBoard, 1), Blocks.glass, Items.slime_ball);
        ...
        GameRegistry.addRecipe(new ItemStack(slimophone, 1), new ItemStack(slimophone, 1, -1), battery);
        ...
        GameRegistry.addRecipe(new ItemStack(redPhosphor), Items.blaze_powder, new ItemStack(Items.dye, 1, 1));
        GameRegistry.addRecipe(new ItemStack(greenPhosphor), Items.blaze_powder, new ItemStack(Items.dye, 1, 2));
        GameRegistry.addRecipe(new ItemStack(bluePhosphor), Items.blaze_powder, new ItemStack(Items.dye, 1, 4));
        ...
        GameRegistry.addRecipe(new ItemStack(colorMiningRadar), miningRadar, colorCRT, colorMiningRadarCircuit);
        GameRegistry.addRecipe(new ItemStack(colorMiningRadar), "CMH", "LFB", "grg",
                ...
                'B', battery, 'g', Items.gold_nugget, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(colorMiningRadar), new ItemStack(colorMiningRadar, 1, -1), battery);
    }
}
